...
namespace ContosoUniversity.Controllers
{
    public class CoursesController : BaseController
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (teachingMaterialImage != null && teachingMaterialImage.Length > 0)
                {
                    ...
                    try
                    {
                        ...
                        var uploadsPath = Path.Combine(_env.ContentRootPath, "Uploads", "TeachingMaterials");
            ...
            if (ModelState.IsValid)
            {
                ...
                if (teachingMaterialImage != null && teachingMaterialImage.Length > 0)
                {
                    ...
                    try
                    {
                        ...
                        {
                            var oldRelativePath = course.TeachingMaterialImagePath.Replace("~/Uploads/", "");
                            var oldFilePath = Path.Combine(_env.ContentRootPath, "Uploads", oldRelativePath);
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            {
                var oldRelativePath = course.TeachingMaterialImagePath.Replace("~/Uploads/", "");
                var filePath = Path.Combine(_env.ContentRootPath, "Uploads", oldRelativePath);
